...
naiveBayes <- setRefClass("naiveBayes",
   ...
   methods = list(
    ...
    predict = function(message) {
      ...
      spam_observation_probability <- rowSums(bag[words,y==1]) / spam_length
      spam_observation_probability <- prod(spam_observation_probability[spam_observation_probability!=0])
      
      ham_observation_probability <- rowSums(bag[words,y==0]) / ham_length
      ham_observation_probability <- prod(ham_observation_probability[ham_observation_probability!=0])
...
#model$predict(test_bag_words[,1])
